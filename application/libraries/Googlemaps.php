...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyA3Lf_RKrQdUAiIVZ7422NDKZcL0Tdf8ZM'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	function add_circle($params = array())
	{
		...
		$circle['strokeColor'] = '#5000ff';						// The hex value of the circles border color
		$circle['strokeOpacity'] = '1';	     					// The opacity of the circle border
		$circle['strokeWeight'] = '2';							// The thickness of the circle border
		$circle['fillColor'] = '#8000ff';						// The hex value of the circles fill color
